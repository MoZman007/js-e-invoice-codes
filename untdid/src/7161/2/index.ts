...
export const UNTDID_7161_2: CodeList = [
	{
		code: "AA",
		name: "Advertising",
	...
	{ code: "ACJ", name: "Painting", description: "The service of painting." },
	{ code: "ACK", name: "Polishing", description: "The service of polishing." },
	{ code: "ACL", name: "Priming", description: "The service of priming." },
	{
		code: "ACM",
		name: "Preservation treatment",
		description: "The service of preservation treatment.",
	},
	{ code: "ACS", name: "Fitting", description: "Fitting service." },
	{
		code: "ADC",
		name: "Consolidation",
		description:
	...
	{ code: "ADM", name: "Binding", description: "Binding service." },
	{
		code: "ADN",
	...
	{ code: "AEC", name: "Distribution", description: "Distribution service." },
	{
		code: "AED",
	...
	{ code: "CAI", name: "Cutting", description: "The service of cutting." },
	{
		code: "CAJ",
	...
	{ code: "CD", name: "Car loading", description: "Car loading service." },
	{ code: "CG", name: "Cleaning", description: "Cleaning service." },
	{
		code: "CS",
	...
	{ code: "EP", name: "Expediting", description: "The service of expediting." },
	{
		code: "ER",
	...
	{ code: "GAA", name: "Grinding", description: "The service of grinding." },
	{
		code: "HAA",
		name: "Hose",
		description: "The service of providing a hose.",
	},
	{ code: "HD", name: "Handling", description: "Handling service." },
	{
		code: "HH",
	...
	{ code: "IF", name: "Inspection", description: "The service of inspection." },
	{
		code: "IR",
	...
	{ code: "LA", name: "Labelling", description: "Labelling service." },
	{
		code: "LAA",
		name: "Labour",
	...
	{ code: "MAE", name: "Mounting", description: "The service of mounting." },
	{
		code: "MI",
		name: "Mail invoice",
	...
	{ code: "PC", name: "Packing", description: "The service of packing." },
	{
		code: "PL",
		name: "Palletizing",
		description: "The service of palletizing.",
	},
	{ code: "RAB", name: "Repacking", description: "The service of repacking." },
	{ code: "RAC", name: "Repair", description: "The service of repairing." },
	{
		code: "RAD",
	...
	{ code: "RV", name: "Loading", description: "The service of loading goods." },
	{ code: "SA", name: "Salvaging", description: "The service of salvaging." },
	{
		code: "SAA",
	...
	{ code: "SAE", name: "Stamping", description: "The service of stamping." },
	{
		code: "SAI",
	...
	{ code: "SU", name: "Set-up", description: "The service of setting-up." },
	{
		code: "TAB",
		name: "Tank renting",
		description: "The service of providing tanks for hire.",
	},
	{ code: "TAC", name: "Testing", description: "The service of testing." },
	{
		code: "TT",
