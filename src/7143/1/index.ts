...
export const UNTDID_7143_1: CodeList = [
	{
		code: "AA",
	...
	{ code: "SRS", name: "RSK number", description: "Plumbing and heating." },
	{
		code: "SRT",
		name: "IFLS (Institut Francais du Libre Service) 5 digit productclassification code",
		description:
