...
export const UNTDID_5189_3: CodeList = [
	{
		code: "1",
	...
	{ code: "33", name: "Phone fee", description: "Fee for use of phone." },
	{ code: "34", name: "Postage fee", description: "Fee for postage." },
	{
		code: "35",
		name: "S.W.I.F.T. fee",
		description: "Fee for use of S.W.I.F.T.",
	},
	{ code: "36", name: "Telex fee", description: "Fee for telex." },
	{
		code: "37",
	...
	{ code: "49", name: "Interest", description: "Cost of using money." },
	{
		code: "50",
	...
	{ code: "80", name: "Packing charge", description: "Charge for packing." },
	{ code: "81", name: "Repair charge", description: "Charge for repair." },
	{ code: "82", name: "Loading charge", description: "Charge for loading." },
	{ code: "83", name: "Setup charge", description: "Charge for setup." },
	{ code: "84", name: "Testing charge", description: "Charge for testing." },
	{
		code: "85",
	...
	{ code: "96", name: "Insurance", description: "Charge for insurance." },
	{
		code: "97",
