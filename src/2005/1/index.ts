...
export const UNTDID_2005_1: CodeList = [
	{
		code: "1",
	...
	{ code: "48", name: "Duration", description: "Duration." },
	{
		code: "49",
	...
	{ code: "121", name: "Entry date", description: "Date of entry." },
	{
		code: "122",
	...
	{ code: "351", name: "Inspection date", description: "Date of inspection." },
	{
		code: "352",
	...
	{ code: "444", name: "Approval date", description: "Date of approval." },
	{
		code: "445",
	...
	{ code: "450", name: "Opening date", description: "Date of opening." },
	{
		code: "451",
	...
	{ code: "545", name: "Assigned date", description: "Date when assigned." },
	{
		code: "546",
	...
	{ code: "549", name: "Completion date", description: "Date of completion." },
	{
		code: "550",
	...
	{ code: "554", name: "Filed date", description: "Date when filed." },
	{
		code: "555",
		name: "Return to work date",
		description: "Date of return to work.",
	},
	{ code: "556", name: "Purchased date", description: "Date of purchase." },
	{
		code: "557",
		name: "Returned date",
	...
	{ code: "564", name: "Signature date", description: "Date of signature." },
	{
		code: "565",
	...
	{ code: "568", name: "Suspended date", description: "Date of suspension." },
	{ code: "569", name: "Renewal date", description: "Date of renewal." },
	{ code: "570", name: "Reported date", description: "Date when reported." },
	{ code: "571", name: "Checked date", description: "Date when checked." },
	{
		code: "572",
	...
	{ code: "578", name: "Meeting date", description: "Date of the meeting." },
	{
		code: "579",
	...
	{ code: "581", name: "Convicted date", description: "Date when convicted." },
	{
		code: "582",
		name: "Interviewed date",
		description: "Date of an interview.",
	},
	{ code: "583", name: "Last visit date", description: "Date of last visit." },
	{ code: "584", name: "Future period", description: "Period in the future." },
	{
		code: "585",
	...
	{ code: "587", name: "Action date", description: "Date of action." },
	{
		code: "588",
	...
	{ code: "590", name: "Resolved date", description: "Date when resolved." },
	{ code: "591", name: "Recorded date", description: "Date when recorded." },
	{
		code: "592",
	...
	{ code: "594", name: "Net worth date", description: "Date of net worth." },
	{
		code: "595",
	...
	{ code: "672", name: "Period assigned", description: "The period assigned." },
	{
		code: "673",
		name: "Lease period",
	...
	{ code: "691", name: "Advising date", description: "Date of advice." },
	{
		code: "692",
	...
	{ code: "751", name: "After date", description: "The specified after date." },
	{
		code: "752",
	...
	{
		code: "756",
		name: "Ultimate documentation date/time for 24-hour rule regulation of CBP (United States Customs and Border Protection)",
		description:
	...
	{ code: "796", name: "Catch date/time", description: "Date/time of catch." },
	{
		code: "797",
